<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Artbeat.Admin.AdminPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server" 
                    ItemType="Artbeat.Models.Category" 
                    SelectMethod="GetCategories" DataTextField="CategoryName" 
                    DataValueField="CategoryID" CssClass="dropdown" >
                </asp:DropDownList>
                <br /><br />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="AddProductName" runat="server" CssClass="form-group"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="AddProductDescription" runat="server" CssClass="form-group"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="AddProductPrice" runat="server" CssClass="form-group"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Text="* Must be a valid price without Rs." ControlToValidate="AddProductPrice" SetFocusOnError="True" Display="Dynamic" ValidationExpression="^[0-9]*(\.)?[0-9]?[0-9]?$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            ...
            <td><asp:DropDownList ID="DropDownRemoveProduct" runat="server" ItemType="Artbeat.Models.Product" 
                    SelectMethod="GetProducts" AppendDataBoundItems="true" 
                    DataTextField="ProductName" DataValueField="ProductID" CssClass="dropdown" >
                </asp:DropDownList>
            </td>
        </tr>
    </table>
    <p></p>
    <asp:Button ID="RemoveProductButton" runat="server" Text="Remove Product" OnClick="RemoveProductButton_Click" CausesValidation="false" CssClass="btn btn-default"/>
